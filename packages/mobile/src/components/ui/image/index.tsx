...
const Image = React.forwardRef<React.ComponentRef<typeof RNImage>, ImageProps>(function Image(
    { size = "md", className, ...props },
    ref
) {
    return <RNImage ref={ref} {...props} className={cn("max-w-full", IMAGE_SIZE_CLASS[size], className)} />;
});
