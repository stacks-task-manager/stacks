...
const Modal = React.forwardRef<React.ComponentRef<typeof RNModal>, IModalProps>(function Modal(
...
const ModalBackdrop = React.forwardRef<React.ComponentRef<typeof Pressable>, IModalBackdropProps>(
...
const ModalContent = React.forwardRef<React.ComponentRef<typeof View>, IModalContentProps>(
...
const ModalHeader = React.forwardRef<React.ComponentRef<typeof View>, IModalHeaderProps>(function ModalHeader(
    { className, ...props },
    ref
) {
    return <View ref={ref} {...props} className={cn("flex-row justify-between items-center", className)} />;
});

type IModalBodyProps = ScrollViewProps & { className?: string };

const ModalBody = React.forwardRef<React.ComponentRef<typeof ScrollView>, IModalBodyProps>(function ModalBody(
    { className, ...props },
    ref
) {
    return <ScrollView ref={ref} {...props} className={cn("mt-2 mb-6", className)} />;
});

type IModalFooterProps = ViewProps & { className?: string };

const ModalFooter = React.forwardRef<React.ComponentRef<typeof View>, IModalFooterProps>(function ModalFooter(
    { className, ...props },
    ref
) {
    return <View ref={ref} {...props} className={cn("flex-row justify-end items-center gap-2", className)} />;
});
