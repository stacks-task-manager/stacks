...
const InputSlot = React.forwardRef<React.ComponentRef<typeof Pressable>, IInputSlotProps>(function InputSlot(
    { className, ...props },
    ref
) {
    return <Pressable ref={ref} {...props} className={cn("justify-center items-center", className)} />;
});
