...
describe("DragDropContext", () => {
    ...
    describe("Drag Start", () => {
            ...
            render(
                <DragDropProvider>
                    <TestContainer
                        id="container"
                        acceptsTypes={["item"]}
                        mockRect={createRect(0, 0, 200, 200)}
                    >
        ...
        it("should set drag state correctly on drag start", () => {
            ...
            const capture: { current: { isDragging: boolean; draggedId: string | null } | null } = {
                current: null,
            };
            ...
            render(
                <DragDropProvider>
                    ...
                    <TestContainer
                        id="container"
                        acceptsTypes={["item"]}
                        mockRect={createRect(0, 0, 300, 200)}
                    >
                        <TestDraggable id="item-1" type="item" containerId="container" mockRect={mockRect}>
                            Item 1
                        </TestDraggable>
            ...
            render(
                <DragDropProvider>
                    <TestContainer id="container" acceptsTypes={["item"]}>
                        <TestDraggable id="item-1" type="item" containerId="container">
                            Item 1
                        </TestDraggable>
                        <TestDraggable id="item-2" type="item" containerId="container">
                            Item 2
                        </TestDraggable>
                        <TestDraggable id="item-3" type="item" containerId="container">
                            Item 3
                        </TestDraggable>
                    </TestContainer>
                </DragDropProvider>
            ...
            render(
                <DragDropProvider>
                    <TestContainer
                        ...
                        mockRect={createRect(0, 0, 200, 200)}
                    >
                        <TestDraggable id="item-1" type="item" containerId="container" mockRect={mockRect1}>
                            Item 1
                        </TestDraggable>
                        <TestDraggable id="item-2" type="item" containerId="container" mockRect={mockRect2}>
                            Item 2
                        </TestDraggable>
                    </TestContainer>
                </DragDropProvider>
                ...
                <DragDropProvider>
                    <TestContainer id="outer" acceptsTypes={["column"]}>
                        <TestContainer id="inner-1" acceptsTypes={["card"]}>
                            <TestDraggable id="card-1" type="card" containerId="inner-1">
                                Card 1
                            </TestDraggable>
                        </TestContainer>
                        <TestContainer id="inner-2" acceptsTypes={["card"]}>
                            <TestDraggable id="card-2" type="card" containerId="inner-2">
                                Card 2
                            </TestDraggable>
                        </TestContainer>
                    </TestContainer>
