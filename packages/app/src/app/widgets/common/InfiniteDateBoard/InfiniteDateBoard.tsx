...
export const InfiniteDateBoard = forwardRef<InfiniteDateBoardPropsRef, InfiniteDateBoardProps>(
    (props, ref) => {
        ...
        useEffect(() => {
            ...
            visibleInfo.firstVisibleIdx,
            visibleInfo.lastVisibleIdx,
            containerWidth,
            getDateFromOffset,
            onDatesLoaded,
        ]);
            ...
            <div className={classNames("infinite-date-board", className)}>
                ...
                >
                    ...
                    >
                        ...
                        <div
                            style={{
                                width: `${CENTER_OFFSET + visibleInfo.renderStart * STEP}px`,
                                flexShrink: 0,
                            }}
                        />

                        {/* We only map the buffer range, keeping the DOM light */}
                        {Array.from({ length: visibleInfo.renderEnd - visibleInfo.renderStart + 1 }).map(
                            (_, index) => {
