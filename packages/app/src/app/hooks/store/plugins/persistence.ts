...
function getItem(
    ...
    if (typeof res !== "string" && typeof (res as Promise<string | null>).then === "function")
        (res as Promise<string | null>).then(val => {
...
function processValue(func: (val: any) => any, value: any, callback: (val: any) => void) {
