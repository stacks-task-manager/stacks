...
describe("Thumbnail Service", () => {
    ...
    describe("generateThumbnail", () => {
        ...
        test("should handle unsupported file types", async () => {
            ...
            await expect(
                ThumbnailService.generateThumbnail(filePath, outputPath, "text/plain", options)
        ...
        test("should handle file processing errors", async () => {
            ...
            await expect(
                ThumbnailService.generateThumbnail(filePath, outputPath, "image/jpeg", options)
            ).rejects.toThrow(
                "Thumbnail generation failed: Image thumbnail generation failed: Sharp processing failed"
            );
        });
    });
    ...
    describe("generateVideoThumbnail", () => {
        ...
        test("should handle file system errors", async () => {
            ...
            await expect(
                ThumbnailService.generateThumbnail(filePath, outputPath, "video/mp4", options)
    ...
    describe("generatePdfThumbnail", () => {
        ...
        test("should handle invalid page numbers", async () => {
            ...
            mockPdf2pic.fromPath.mockReturnValue(vi.fn().mockRejectedValue(new Error("Invalid page number")));
        ...
        test("should handle PDF loading errors", async () => {
            ...
            mockPdf2pic.fromPath.mockReturnValue(vi.fn().mockRejectedValue(new Error("File not found")));
