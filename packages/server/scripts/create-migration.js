...
const TABLE_DEFINITIONS = {
    ...
    attachments: {
        ...
        type: {
            type: `Sequelize.ENUM(${ENUM_MAPPINGS.FILES_TYPE.join(", ")})`,
            allowNull: false,
            defaultValue: '"file"',
        },
        id: { type: "Sequelize.UUID", defaultValue: "Sequelize.UUIDV4", primaryKey: true, allowNull: false },
    ...
    timelogs: {
        ...
        status: {
            type: `Sequelize.ENUM(${ENUM_MAPPINGS.TIMELOG_STATUS.join(", ")})`,
            allowNull: true,
            defaultValue: '"pending"',
        },
    ...
    users: {
        ...
        gender: {
            type: `Sequelize.ENUM(${ENUM_MAPPINGS.PEOPLE_GENDER.join(", ")})`,
            allowNull: true,
            defaultValue: '"other"',
        },
        ...
        onlineStatus: {
            type: `Sequelize.ENUM(${ENUM_MAPPINGS.USER_ONLINE_STATUS.join(", ")})`,
            allowNull: true,
        },
        disabled: { type: "Sequelize.BOOLEAN", allowNull: true, defaultValue: false },
