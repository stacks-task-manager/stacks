 ...
 *
 * Explicit release: `node pre-build.cjs patch` | `minor` | `major` (always bumps).
 */
...
async function preBuild() {
    if (!isVersionBumpEnabled()) {
        console.log(
            "pre-build: skipped package.json version bump (set STACKS_BUMP_PACKAGE_VERSION=1 to enable, or run `node pre-build.cjs patch`)",
        );
        return;
    }
